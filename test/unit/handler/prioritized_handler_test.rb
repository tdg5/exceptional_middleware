...
require "exceptional_middleware/handler/instance_handler"
require "exceptional_middleware/handler/prioritized_handler"

class ExceptionalMiddleware::Handler::PrioritizedHandlerTest < ExceptionalMiddleware::TestCase
  Subject = ExceptionalMiddleware::Handler::PrioritizedHandler
  InstanceHandler = ExceptionalMiddleware::Handler::InstanceHandler
